    ...
    <div class="app-container">
        ...
        <el-card :shadow="publicConfigStore.cardShadow" class="search-card">
            <el-form class="queryForm" :model="queryParams" ref="queryRef" :inline="true"
                ...
                <template v-for="(item, index) in backListQuery" :key="index">
        ...
        <el-card :shadow="publicConfigStore.cardShadow">
            <div class="table-total">
                ...
                <div>
                    <!-- <el-button  type="primary" class="export" @click="handleExport(true)">导入</el-button> -->
                <el-button type="primary" @click="handleMeg({},1)">新增黑名单</el-button>
                </div>
...
import { getBlackUserList,moveBlackUser} from "@/api/system/customer";
...
const delSubmit = async (pwd) => {
	debugger
    const res = await moveBlackUser({ auditPassword: pwd, leaderName: superiorName.value, id: rowSelect.value.id })
    if (res.code == 200){
